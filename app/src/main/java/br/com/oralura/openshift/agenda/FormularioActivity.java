...
public class FormularioActivity extends AppCompatActivity {
    ...
    public static final int INTENT_CAMERA = 567;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botaoFoto = (Button) findViewById(R.id.formulato_botao_foto);
        ...
        if(aluno != null) {
            helper.preencheFomulario(aluno);
        }
    }
